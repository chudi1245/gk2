...
$mw->Label(-text=>'原文件名',-font =>[-size => 12],-width=>20)                  ->grid(-column=>2,-row=>0,-ipady=>2,-sticky=>"ew",);
...
##$mw->Button(-text=>'检查名称',-command=>\&check_file,-font =>[-size => 12],-width=>20)  ->grid(-column=>2,-row=>4,-ipady=>2,-sticky=>"ew",);
...
###___________________________________end of disname

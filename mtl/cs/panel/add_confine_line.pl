...
##my $length=0.3;
my @confine_line=(
 {x=>$main::SR_xmax+0.03937,  y=>$main::SR_ymax+0.03937,},
 {x=>$main::SR_xmin-0.03937,  y=>$main::SR_ymax+0.03937,},
 {x=>$main::SR_xmin-0.03937,  y=>$main::SR_ymin-0.03937,},
 {x=>$main::SR_xmax+0.03937,  y=>$main::SR_ymin-0.03937,},
);


clear();
    affected_layer('yes', 'single', @{$main::layer_class{line}} );
    add_line($confine_line[0]{x},$confine_line[0]{y},$confine_line[1]{x},$confine_line[1]{y},'r10');
    add_line($confine_line[1]{x},$confine_line[1]{y},$confine_line[2]{x},$confine_line[2]{y},'r10');
    add_line($confine_line[2]{x},$confine_line[2]{y},$confine_line[3]{x},$confine_line[3]{y},'r10');
    add_line($confine_line[3]{x},$confine_line[3]{y},$confine_line[0]{x},$confine_line[0]{y},'r10');
 clear();
